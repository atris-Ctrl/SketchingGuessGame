...
canvas.addEventListener("mousedown", (e)=>{
    ...
    drawSketch(e.clientX - rect.left, e.clientY - rect.top);
});
canvas.addEventListener("mousemove", (e)=>{
    ...
    drawSketch(e.clientX - rect.left, e.clientY - rect.top);
// drawSketch(e.clientX - canvas.offsetLeft, e.clientY - canvas.offsetTop);
});
...
function drawSketch(x, y) {
    ...
    ctx.beginPath();
    ctx.moveTo(x, y);
    updatePenSizeIndicator(x + rect.left, y + rect.top, ctx.lineWidth);
}
...
},{}]},["2Yh4E","jUTag"], "jUTag", "parcelRequirec3ae")
